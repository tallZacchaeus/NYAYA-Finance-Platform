...
class FinanceRequestService
{
    ...
    {
        $path = $file->store('request-documents', 'public');
    ...
    private function generateReference(): string
    {
        ...
        // Atomic sequence: find max sequence for this year and increment
        $last = FinanceRequest::withTrashed()
            ->where('reference', 'like', "YAYA-{$year}-%")
            ->lockForUpdate()
            ->max('reference');
        ...
        return sprintf('YAYA-%d-%05d', $year, $sequence);
    }
}
